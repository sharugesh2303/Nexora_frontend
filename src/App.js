...
        posts: [],
        projects: [],
        schedules: [], // Ensure this is initialized if you use it later
    });
...
                about: { ...res.data.about, sections: res.data.about.sections || [] },
                // Add schedules placeholder, even though it's not fetched here
                schedules: [], 
            });
            setLoading(false);
        } catch (err) {
