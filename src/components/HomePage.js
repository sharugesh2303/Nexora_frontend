...
// --- API Configuration ---
// Uses the updated key name from the environment.
...
const HomePage = ({ onNavigate = () => {}, generalData = {}, homeData = {} }) => {
    ...
    useEffect(() => {
        ...
        const fetchMilestones = async () => {
            try {
                // Use the pre-calculated URL constant
                ...
                // Log detailed error for debugging deployed environment
        ...
        poll();
        // Keep polling to ensure milestones update if they change
    ...
    /* ---------- Canvas / stars drawing (unchanged) ---------- */
    useEffect(() => {
