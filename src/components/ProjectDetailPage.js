...
const HeaderImage = styled.img`
  width: auto;
  height: 72vh;               /* tall so vertical photos show clearly */
  max-width: 100%;
  object-fit: contain;        /* show entire vertical image without cropping */
  display: block;
  margin: 0 auto;
`;
...
const ProjectDetailPage = ({ onNavigate, projects }) => {
  ...
  // keep original semantics: if projects prop empty show Loading...
