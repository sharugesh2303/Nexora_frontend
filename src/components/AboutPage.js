...
/* =========================================
   LAYOUT COMPONENTS (RESTORED TO HOME PAGE SIZE)
   ========================================= */
const PageWrapper = styled.div`
    position: relative; z-index: 1; min-height: 100vh; background: transparent;
`;

// --- HEADER: STANDARD SIZE (Matches Home) ---
...
const Logo = styled.h1`
    color: ${NEON_COLOR}; font-size: 1.8rem; 
    font-weight: 800; cursor: pointer; letter-spacing: 1px; margin: 0; white-space: nowrap;
...
const NavGroup = styled.div`
    ...
    span {
        color: #6B7280; cursor: pointer; font-weight: 500; position: relative;
...
const MobileNavMenu = styled.div`
    ...
    span { font-size: 1.3rem; margin: 15px 0; cursor: pointer; color: #6B7280; &:hover { color: ${NEON_COLOR}; } }
`;

/* =========================================
   BODY SECTIONS (BIGGER FONTS KEPT)
   ========================================= */
...
const MetricCard = styled.div`
    ...
    .icon-box {
        ...
        color: ${NEON_COLOR}; font-size: 2.2rem; margin-bottom: 10px;
    }
...
const SectionHeader = styled.h2`
    font-size: 3.8rem; /* Bigger Section Headers */
...
const SectionSubtitle = styled.p`
    ...
    font-size: 1.5rem; /* Bigger Subtitles */
...
const MVJCard = styled.div`
    ...
    .icon-box {
        ...
        margin-bottom: 25px; color: ${NEON_COLOR}; font-size: 2.5rem;
    }
...
/* =========================================
   FOOTER STYLES (RESTORED TO HOME PAGE SIZE)
   ========================================= */
