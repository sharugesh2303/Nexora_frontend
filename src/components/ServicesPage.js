...
<<<<<<< HEAD
// CORRECTION 1: Removed unused variable CARD_BG
=======
...
  display:flex;
  gap: 18px;
  /* CORRECTION 2: Changed 'a' selector to 'span' to avoid accessibility warning for missing href */
  span { 
    color: ${MUTED_TEXT}; 
    font-weight:600; 
    cursor: pointer; 
    text-decoration:none; 
    /* The span now acts like an anchor tag */
  }
...
/* Icon map (keeps original mapping) */
const iconMap = {
<<<<<<< HEAD
...
/* ---------- STAR CANVAS FUNCTIONALITY (same engine as other pages) ---------- */
...
          <Nav>
            {/* CORRECTION 2: Changed <a> to <span> to remove the requirement for an href attribute, fixing the build error */}
      ...
      <Page>
        <Header>
          ...
          <Nav>
            ...
            <a className="active" onClick={() => onNavigate('services')}>Services</a>
