    ...
    <>
      ...
      <Page>
        ...
        <FAQSection>
          ...
          <FAQMain>
            <IntroTitle style={{ fontSize: '1.8rem', marginBottom: '10px' }}>Frequently Asked <span>Questions</span></IntroTitle>
            <IntroSubtitle>Find quick answers about our services, process, and commitment.</IntroSubtitle>
        ...
        <Footer>&copy; NEXORACREW Team</Footer>
      </Page>
    </>
  );
};
